      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl heading-primary text-gray-900 mb-6">
            Trusted <span className="text-green-600">{serviceData.service}</span> Professionals
          </h2>
              ...
              return (
                <div key={index} className="text-center">
                  <div className="relative mb-6">
                    <div className="w-20 h-20 mx-auto bg-blue-500 text-white rounded-full flex items-center justify-center">
                      <IconComponent size={28} />
                    </div>
                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                      <Badge variant="secondary" className="bg-white text-blue-600 font-bold px-3 py-1">
                        {standard.stat}
                      </Badge>
                    </div>
                  </div>
        ...
        <div className="bg-blue-500 rounded-2xl p-8 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-blue-100 body-text mb-6 text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-600/50 rounded-lg p-4">
                ...
                <div className="text-blue-100 text-sm">$2M general liability insurance</div>
              </div>
              
              <div className="bg-blue-600/50 rounded-lg p-4">
                <div className="text-2xl mb-2">👥</div>
                <div className="text-lg font-semibold mb-1">Workers Comp</div>
                <div className="text-blue-100 text-sm">Full workers compensation coverage</div>
              </div>
              
              <div className="bg-blue-600/50 rounded-lg p-4">
                <div className="text-2xl mb-2">✅</div>
                <div className="text-lg font-semibold mb-1">Satisfaction Guarantee</div>
                <div className="text-blue-100 text-sm">100% satisfaction guaranteed</div>
              </div>
            </div>
          </div>
        </div>
