  ...
  return (
    <section className="relative hero-with-header-and-breadcrumbs flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={`${cityData.image_url}${cityData.image_url.includes('?') ? '&' : '?'}w=1920&h=1080&q=75&fm=webp&auto=format`}
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-water-primary/85 to-water-secondary/40"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          {/* Location Badge */}
          <div className="inline-flex items-center gap-2 bg-water-primary text-white px-6 py-3 rounded-full text-sm font-medium">
            <MapPin size={16} />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
            ...
            >
              ...
              <a href="tel:+18886806768">Call Emergency: (888) 680-6768</a>
            </Button>
            <Button 
